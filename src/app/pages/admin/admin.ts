...
type AdminView = 'summary' | 'documents' | 'users' | 'analytics' | 'profile';
...
export class Admin {
  ...
  protected pageLabel(path: string): string { return ({ '/': 'Inicio', '/quienes-somos': 'Quiénes somos', '/que-hacemos': 'Qué hacemos', '/presencia': 'Presencia', '/documentos': 'Documentos' } as Record<string, string>)[path] ?? path; }
